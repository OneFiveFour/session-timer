...
import net.onefivefour.sessiontimer.core.usecases.timer.InitSessionTimerUseCaseImpl
...
internal interface TimerModule {
    ...
    @Binds
    @ViewModelScoped
    fun bindInitSessionTimerUseCase(impl: InitSessionTimerUseCaseImpl): InitSessionTimerUseCase
